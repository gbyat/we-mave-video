...
function updatePluginMainFile() {
	...
	content = content.replace(
		/define\(\s*'WE_MAVE_VIDEO_VERSION',\s*'[^']*'\s*\);/,
		`define( 'WE_MAVE_VIDEO_VERSION', '${version}' );`
	);
